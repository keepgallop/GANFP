...
python3 gan/main.py \
--dataset celebA \
--data_dir ../../celeba_datasets/training/ \
--checkpoint_dir models/ \
--output_dir_of_test_samples celeba_align_png_cropped/ \
--no_of_samples 5000 \
--model cramer --name cramer_gan \
--architecture g_resnet5 --output_size 128 --dof_dim 256 \
--gradient_penalty 10. \
...
###LSUN###
python3 gan/main.py \
--dataset lsun_bedroom_200k \
--data_dir ../../lsun_datasets/training/ \
--checkpoint_dir models/ \
--output_dir_of_test_samples lsun_bedroom_200k_png/ \
--no_of_samples 5000 \
--model cramer --name cramer_gan \
--architecture g_resnet5 --output_size 128 --dof_dim 256 \
--gradient_penalty 10. \
