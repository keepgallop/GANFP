...
class Cramer_GAN(MMD_GAN):                   
    ...
    def set_loss(self, G, G2, images):
        ...
        #print("#real_data.shape: ", real_data.shape) #real_data.shape:  (32, 128, 128, 3)
        #print("#fake_data.shape: ", fake_data.shape) #fake_data.shape:  (32, 128, 128, 3)
        fingerprint_weight = 1.0
        real_features_out = self.feature_extractor(real_data)
        fake_features_out = self.feature_extractor(fake_data)
