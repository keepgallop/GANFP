...
#-----------------------------------------------------------------------------------------
# 运行此文件前，请先运行datasets/celeba.py文件
"""
cd Anonymize_SNGAN/
...
--data_dir ../Original_CelebA_images/Celeba/ \
...
--results_dir models/celeba_align_png_cropped \
--snapshot models/celeba_align_png_cropped/ResNetGenerator_8000.npz \
--loaderjob 32

###LSUN###
python3 train.py \
--config_path configs/sn_projection_lsun_bedroom_200k.yml \
--data_dir ../datasets/training/ \
--results_dir models/lsun_bedroom_200k_png \
--loaderjob 32
"""
# config_path: config文件所在的目录，项目自带；
# data_dir: 由data_preparation.py生成的图片所在路径；
